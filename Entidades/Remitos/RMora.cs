...
namespace Aguiñagalde.Entidades
{
    public class RMora : Remito
    {
        ...
        public RMora(int xNumero,string xSerie, DateTime xFecha, Moneda xMoneda, int xCodTarifa, int xCodVendedor, ClienteActivo xCliente, List<LineaRemito> xLineas, string xComentario,SubCuenta xSubCuenta)
